  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
        ...
        <p className="mb-2"><span className="font-medium">Téléphone :</span> 06 XX XX XX XX</p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
        ...
        <p className="mb-2"><span className="font-medium">Site web :</span> <a href="https://www.ovhcloud.com" className="text-blue-500 hover:underline">www.ovhcloud.com</a></p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
        ...
        <p className="mb-4">
          ...
          <a href="https://cnpm-mediation-consommation.eu" className="text-blue-500 hover:underline">https://cnpm-mediation-consommation.eu</a>
        </p>
        <p className="mb-4">
          <span className="font-medium">Plateforme européenne de résolution des litiges en ligne :</span><br />
          <a href="https://ec.europa.eu/consumers/odr" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">https://ec.europa.eu/consumers/odr</a>
        </p>
      </div>
