    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
        ...
        <ul className="list-none pl-5 space-y-2">
          <li><span className="font-medium">Société :</span> Chanvre Vert SAS</li>
          <li><span className="font-medium">Adresse :</span> 123 Avenue du Chanvre, 75000 Paris, France</li>
          <li><span className="font-medium">Email :</span> privacy@chanvre-vert.fr</li>
          <li><span className="font-medium">Téléphone :</span> +33 1 23 45 67 89</li>
        </ul>
      </div>
