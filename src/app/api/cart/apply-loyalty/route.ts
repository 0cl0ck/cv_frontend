...
/**
 * Route BFF pour appliquer les avantages de fidélité au panier
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(`${BACKEND_URL}/api/cart/apply-loyalty`, {
      method: 'POST',
      headers: {
    ...
    console.error('[BFF /api/cart/apply-loyalty] Error:', error);
