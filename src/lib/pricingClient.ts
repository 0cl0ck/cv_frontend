...
export interface PricingTotals {
  ...
  appliedWallet?: { eligible: boolean; usableBalance: number; appliedAmount?: number; message?: string } | null;
...
type CalculateCartTotalsOptions = {
  ...
  country?: string;
  promoCode?: string;
  applyWallet?: boolean; // Si true, applique la cagnotte au calcul
};
